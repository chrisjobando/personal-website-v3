    ...
    >
      ...
      <div className="description">
        ...
        <div className="reflection">
          ...
          <p style={{ marginTop: 0 }}>
            i was very fortunate to join the bridge team right at the start of a
            major refactor.
          </p>
          <p>
          ...
          <p>
            ...
            <span className="bold"> $12.5 billion</span> in sales in 2019, but i
            also worked on a <span className="bold">scrum</span> team and was
            able to present my research and work with the entire team during our
            daily standups and biweekly retrospectives.
          </p>
          <p>
            i would like to thank my hiring manager{" "}
            <span className="bold">matt mills</span> for his support throughout
            the recruitment process as well as for checking up on me every other
            week, our engineering lead{" "}
            <span className="bold">david witherspoon</span> for making sure i
            always had meaningful work to do, and one of my teammates
            <span className="bold"> alden o’neil </span> for always answering my
            many questions throughout my internship.
          </p>
        </div>

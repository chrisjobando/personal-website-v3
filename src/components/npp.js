        ...
        <div className="nonprofit module">
            ...
            <div className="second-row">
                <div className="demo-img">
                    <Img fluid={data.nppDemo.childImageSharp.fluid} imgStyle={{objectFit: 'contain'}} />
                </div>
                <div className="npp-icons">
                    <FontAwesomeIcon icon={faReact} className="icon" size="4x" />
                    <img src={nextLogo}  className="icon" alt="Next Logo" style={{width: "4em"}} />
                    <img src={mongoLogo} className="icon" alt="Mongo Logo" style={{width: "4em"}} />
                </div>
            </div>
        </div>
    );

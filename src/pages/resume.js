...
const ResumePage = () => (
 <div>
    ...
    <div style={{textAlign: "center"}}>
        <a href={ Resume } className="resume-pdf" download>see pdf.</a>
    </div>
    <div className="resume-container">
        ...
        <div className="subsection">
            ...
            <div className="sub-text">
                ...
                <p>- relevant coursework: 3d user interfaces, computer animation, human language
                processing, media device architectures, objects and design, intro to cognitive science,
                applied combinatorics, data structures and algorithms, honors discrete math</p>
            </div>
            <div className="sub-head">
            ...
            <div className="sub-text">
                ...
                <p>- relevant coursework: user interfaces, computer graphics, film production</p>
            </div>
            <div className="sub-head">
        ...
        <div className="subsection">
            <div className="sub-head">
                <div className="sub-sub-head">
                    ...
                    <h2 className="sub-head3"><span className="sub-dash">- </span>software engineering intern</h2>
                </div>
            ...
            <div className="sub-text">
                <p>- reduced security threats detected through fortify security software by implementing safer coding solutions in java</p>
                <p>- worked in a diverse agile/scrum team of developers and qa engineers on the elavon bridge application</p>
                <p>- designed junit5 test cases to detect bugs and fix them</p>
                <p>- presented all development changes during daily standup meetings and biweekly sprint review meetings</p>
            </div>
            <div className="sub-head">
                <div className="sub-sub-head">
                    <h2 className="sub-head2">georgia institute of technology</h2>
                    <h2 className="sub-head3"><span className="sub-dash">- </span>computational services intern</h2>
                </div>
                <h2 className="sub-head-date">feb 2018 to dec 2018</h2>
            </div>
            <div className="sub-text">
                <p>- operated under the office of information technology for the ivan allen college of liberal arts and dilac vr lab</p>
                <p>- provided technical support for professors and students in three seperate buildings on campus</p>
                <p>- diagnosed issues with machines and was dispatched to fix both software and hardware issues</p>
            </div>
        </div>
        ...
        <div className="subsection">
            <div className="sub-head">
                <div className="sub-sub-head">
                    <h2 className="sub-head2">georgia institute of technology</h2>
                    <h2 className="sub-head3"><span className="sub-dash">- </span>teaching assistant</h2>
                </div>
                <h2 className="sub-head-date">jan 2020 to present</h2>
            </div>
            <div className="sub-text">
                <p>- gained teaching experience through weekly recitation lectures</p>
                <p>- integrated a needed automated grading system using the canvas api and python scripts</p>
                <p>- enabled students in the course to succeed through personalized teaching methods, holding office hours, and being aware of external academic and emotional resources available for students</p>
            </div>
            <div className="sub-head">
                <div className="sub-sub-head">
                    <h2 className="sub-head2">bits of good</h2>
                    <h2 className="sub-head3"><span className="sub-dash">- </span>director of community</h2>
                </div>
                <h2 className="sub-head-date">dec 2019 to present</h2>
            </div>
            <div className="sub-text">
                <p>- planning internal community events, such as socials, mixers, and member retreats</p>
            ...
            <div className="sub-head">
                <div className="sub-sub-head">
                    <h2 className="sub-head2">bits of good</h2>
                    <h2 className="sub-head3"><span className="sub-dash">- </span>lead frontend developer</h2>
                </div>
                <h2 className="sub-head-date">aug 2019 to present</h2>
            </div>
            <div className="sub-text">
                <p>- working in an agile development cycle to create web applications for nonprofits in atlanta</p>
                <p>- programming client-side web application in react/nextjs/mongodb</p>
                <p>- coordination with the lead designers to implement their vision for the applications's user interface</p>
            </div>
            <div className="sub-head">

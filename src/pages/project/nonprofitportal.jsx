    ...
    <div>
      ...
      >
        <div className={style.Content}>
          ...
          <h4>
            In previous semesters, GT Bits of Good relied on email for
            nonprofits to connect with them. While this worked, it was clearly
            not optimal for establishing fluid and clear communication.
          </h4>
          <h4>

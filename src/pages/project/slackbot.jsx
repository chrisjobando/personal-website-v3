  ...
  return (
    <div>
      ...
      <div className={style.Content}>
        <h4>
          This application was created using Python, the Slack API, and MongoDB
          for the database.
        </h4>
        <h4>
          As the director of community for GT Bits of Good, one of my biggest
          responsibilities was to increase member engagement and retention, and
          I had a pre-existing participation system called “bits” that I had to
          continue to use/manage.
        </h4>

        <h4>
          I used my background in Python as well as the Slack API and a MongoDB
          database to create a Slack bot which could log member “bits”, display
          important information to general members, and monitor member

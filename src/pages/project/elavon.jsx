    ...
    <div>
      ...
      >
        <div className={style.Content}>
          ...
          <h4>
            Working on a code refactor team, fixing security issues, writing
            JUnit tests
          </h4>
          <h4 className={style.Bold}>Reflection:</h4>
          <h4>
            I was very fortunate to join the Elavon Bridge team right at the
            start of a major refactor.
          </h4>
          <h4>
            I learned the ins and outs of the new code-base and had my first
            true opportunity to apply the fundamentals of Java from my first two
            years at Georgia Tech towards a real-world software solution.
          </h4>
          <h4>
